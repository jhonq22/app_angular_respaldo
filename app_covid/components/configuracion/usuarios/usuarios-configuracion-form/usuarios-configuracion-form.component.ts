...
@Component({
  selector: 'app-usuarios-configuracion-form',
  templateUrl: './usuarios-configuracion-form.component.html',
  styleUrls: ['./usuarios-configuracion-form.component.css']
})
export class UsuariosConfiguracionFormComponent implements OnInit {
    ...
    if (params.id)
        ...
        GuardarUsuario() {
            ...
            this.userService.register(this.Form.value).subscribe(
              res => {
                    console.log(res);
                    this.router.navigate(['/usuarios/configuracion/list']);
                    Swal.fire(
                      'Exitoso!',
