...
@Component({
  selector: 'app-vacunas-recibidas-registrador-form',
  templateUrl: './vacunas-recibidas-registrador-form.component.html',
  styleUrls: ['./vacunas-recibidas-registrador-form.component.css']
})
export class VacunasRecibidasRegistradorFormComponent implements OnInit {
        ...
        informacionUsuario() {
          this.auth.profile().subscribe(
            res => {
             ...
             this.getCentroSalud(this.usuarios.user.estado_id);
