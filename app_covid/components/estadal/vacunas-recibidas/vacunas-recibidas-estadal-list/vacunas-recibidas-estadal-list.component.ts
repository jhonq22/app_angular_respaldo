...
@Component({
  selector: 'app-vacunas-recibidas-estadal-list',
  templateUrl: './vacunas-recibidas-estadal-list.component.html',
  styleUrls: ['./vacunas-recibidas-estadal-list.component.css']
})
export class VacunasRecibidasEstadalListComponent implements OnInit {
  ...
  getVacunasRecibidas()
  {
    ...
    this.comboListService.getVacunasRecibidasEstadal(params.id).subscribe(res => {
      this.vacunas = res;
      console.log(res);
    },
    err => {
