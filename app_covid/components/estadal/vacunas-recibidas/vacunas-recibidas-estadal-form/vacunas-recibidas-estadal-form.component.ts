...
@Component({
  selector: 'app-vacunas-recibidas-estadal-form',
  templateUrl: './vacunas-recibidas-estadal-form.component.html',
  styleUrls: ['./vacunas-recibidas-estadal-form.component.css']
})
export class VacunasRecibidasEstadalFormComponent implements OnInit {
        ...
        informacionUsuario() {
          this.auth.profile().subscribe(
            res => {
             ...
             this.Form.get('estado_id').setValue(this.usuarios.user.estado_id);

             this.getMunicipios(this.usuarios.user.estado_id);
