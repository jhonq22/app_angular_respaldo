...
@Component({
  selector: 'app-visor-estadal-reportes-estadal',
  templateUrl: './visor-estadal-reportes-estadal.component.html',
  styleUrls: ['./visor-estadal-reportes-estadal.component.css']
})
export class VisorEstadalReportesEstadalComponent implements OnInit {
  ...
  reporteVacunasEdadEstado()
{
  ...
  this.vacunasService.reporteVacunasEdadEstado(params.id).subscribe(res => {
